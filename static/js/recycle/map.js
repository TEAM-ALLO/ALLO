...
var locations = [
    ...
    [37.6126032, 127.0448073, "서울특별시 성북구 장위로 24길 48", "서울특별시 성북구 "],
    ...
    [37.59191787, 127.0198086, "서울특별시 성북구울 장월로 40", "서울특별시 성북구 "],
    ...
    [37.61355611, 127.0534941, "서울특별시 성북구 돌곶이로 32-27", "서울특별시 성북구 "],
    [37.59191787, 127.0198086, "서울특별시 성북구 장월로 49길 18", "서울특별시 성북구 "],
    [37.59191787, 127.0198086, "서울특별시 성북구 장월로 49길 17", "서울특별시 성북구 "],
    [37.59191787, 127.0198086, "서울특별시 성북구 장월로 49길 16", "서울특별시 성북구 "],
    [37.60604073, 127.0601807, "서울특별시 성북구 돌곶이로 9나길 12", "서울특별시 성북구 석관동332-155번지 "],
    [37.60939993, 127.0599686, "서울특별시 성북구 돌곶이로 22가길 5", "서울특별시 성북구 "],
    ...
    [37.59754182, 126.9974261, "서울특별시 성북구 선잠로 96-1", "서울특별시 성북구 "],
    ...
    [37.58525188, 127.0287501, "서울특별시 성북구 고려대로 22길 41    ", "서울특별시 성북구 "],
    ...
    [37.5808657, 127.0224215, "서울특별시 성북구 안암로 1길   ", "서울특별시 성북구 "],
...
// trim(): 문자열 양끝의 공백 제거하고 새로운 문자열 반환
    ...
    if (keyword === '의류수거함' || keyword === '헌옷수거함') {
        displayFixedPlaces(locations);
    } else {
